// scrapePropertyDotComHtml.test.ts
...
test("property page scraping with mocked responses", async () => {
  ...
  await page.goto("https://www.property.com.au/test");
  ...
  expect(html).toContain("$2,300,000 - $2,500,000"); // Price guide
