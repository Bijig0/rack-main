// scrapeRealEstateDotComHtml.test.ts
...
test("realestate.com.au page scraping with mocked responses", async () => {
  ...
  await page.goto("https://www.realestate.com.au/test");
  ...
  expect(html).toContain("Land Size: 650"); // Land size
  expect(html).toContain("Bedrooms: 4");
  expect(html).toContain("Bathrooms: 2");
  expect(html).toContain("Car Spaces: 2");
  expect(html).toContain("$2,400,000"); // Price
