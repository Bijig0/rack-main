...
import { formatAddressForRealEstateDotComUrl } from "./formatAddressForRealEstateDotComUrl";

describe("formatAddressForRealEstateDotComUrl", () => {
  it("formats a simple address correctly", () => {
    ...
    const result = formatAddressForRealEstateDotComUrl(address);
