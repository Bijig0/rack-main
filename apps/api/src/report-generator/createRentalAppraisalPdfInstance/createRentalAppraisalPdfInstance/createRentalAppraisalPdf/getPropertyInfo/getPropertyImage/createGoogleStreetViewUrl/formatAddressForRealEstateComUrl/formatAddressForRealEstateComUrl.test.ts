...
import { formatAddressForRealEstateComUrl } from "./formatAddressForRealEstateComUrl";

describe("formatAddressForRealEstateComUrl", () => {
  it("formats a simple address correctly", () => {
    ...
    const result = formatAddressForRealEstateComUrl(address);
