...
/**
 * Migration script to load traffic signal volume CSV data into PostgreSQL
 *
 * This script:
 * 1. Connects to the PostgreSQL database
 * 2. Reads CSV files from the traffic data directory
 * 3. Parses and validates the data
 * 4. Bulk inserts the data into the traffic_signal_volumes table
 *
 * Usage: bun run load_traffic_data.ts [--file <path>] [--directory <path>] [--dry-run]
 */
...
/**
 * Parse a CSV file and return an array of traffic records
 */
function parseCSVFile(filePath: string): TrafficRecord[] {
  ...
  return records.map((record: any) => ({
    ...
    v00: parseInt(record.V00) || 0,
    v01: parseInt(record.V01) || 0,
    v02: parseInt(record.V02) || 0,
    v03: parseInt(record.V03) || 0,
    v04: parseInt(record.V04) || 0,
    v05: parseInt(record.V05) || 0,
    v06: parseInt(record.V06) || 0,
    v07: parseInt(record.V07) || 0,
    v08: parseInt(record.V08) || 0,
    v09: parseInt(record.V09) || 0,
    v10: parseInt(record.V10) || 0,
    v11: parseInt(record.V11) || 0,
    v12: parseInt(record.V12) || 0,
    v13: parseInt(record.V13) || 0,
    v14: parseInt(record.V14) || 0,
    v15: parseInt(record.V15) || 0,
    v16: parseInt(record.V16) || 0,
    v17: parseInt(record.V17) || 0,
    v18: parseInt(record.V18) || 0,
    v19: parseInt(record.V19) || 0,
    v20: parseInt(record.V20) || 0,
    v21: parseInt(record.V21) || 0,
    v22: parseInt(record.V22) || 0,
    v23: parseInt(record.V23) || 0,
    v24: parseInt(record.V24) || 0,
    v25: parseInt(record.V25) || 0,
    v26: parseInt(record.V26) || 0,
    v27: parseInt(record.V27) || 0,
    v28: parseInt(record.V28) || 0,
    v29: parseInt(record.V29) || 0,
    v30: parseInt(record.V30) || 0,
    v31: parseInt(record.V31) || 0,
    v32: parseInt(record.V32) || 0,
    v33: parseInt(record.V33) || 0,
    v34: parseInt(record.V34) || 0,
    v35: parseInt(record.V35) || 0,
    v36: parseInt(record.V36) || 0,
    v37: parseInt(record.V37) || 0,
    v38: parseInt(record.V38) || 0,
    v39: parseInt(record.V39) || 0,
    v40: parseInt(record.V40) || 0,
    v41: parseInt(record.V41) || 0,
    v42: parseInt(record.V42) || 0,
    v43: parseInt(record.V43) || 0,
    v44: parseInt(record.V44) || 0,
    v45: parseInt(record.V45) || 0,
    v46: parseInt(record.V46) || 0,
    v47: parseInt(record.V47) || 0,
    v48: parseInt(record.V48) || 0,
    v49: parseInt(record.V49) || 0,
    v50: parseInt(record.V50) || 0,
    v51: parseInt(record.V51) || 0,
    v52: parseInt(record.V52) || 0,
    v53: parseInt(record.V53) || 0,
    v54: parseInt(record.V54) || 0,
    v55: parseInt(record.V55) || 0,
    v56: parseInt(record.V56) || 0,
    v57: parseInt(record.V57) || 0,
    v58: parseInt(record.V58) || 0,
    v59: parseInt(record.V59) || 0,
    v60: parseInt(record.V60) || 0,
    v61: parseInt(record.V61) || 0,
    v62: parseInt(record.V62) || 0,
    v63: parseInt(record.V63) || 0,
    v64: parseInt(record.V64) || 0,
    v65: parseInt(record.V65) || 0,
    v66: parseInt(record.V66) || 0,
    v67: parseInt(record.V67) || 0,
    v68: parseInt(record.V68) || 0,
    v69: parseInt(record.V69) || 0,
    v70: parseInt(record.V70) || 0,
    v71: parseInt(record.V71) || 0,
    v72: parseInt(record.V72) || 0,
    v73: parseInt(record.V73) || 0,
    v74: parseInt(record.V74) || 0,
    v75: parseInt(record.V75) || 0,
    v76: parseInt(record.V76) || 0,
    v77: parseInt(record.V77) || 0,
    v78: parseInt(record.V78) || 0,
    v79: parseInt(record.V79) || 0,
    v80: parseInt(record.V80) || 0,
    v81: parseInt(record.V81) || 0,
    v82: parseInt(record.V82) || 0,
    v83: parseInt(record.V83) || 0,
    v84: parseInt(record.V84) || 0,
    v85: parseInt(record.V85) || 0,
    v86: parseInt(record.V86) || 0,
    v87: parseInt(record.V87) || 0,
    v88: parseInt(record.V88) || 0,
    v89: parseInt(record.V89) || 0,
    v90: parseInt(record.V90) || 0,
    v91: parseInt(record.V91) || 0,
    v92: parseInt(record.V92) || 0,
    v93: parseInt(record.V93) || 0,
    v94: parseInt(record.V94) || 0,
    v95: parseInt(record.V95) || 0,
...
async function insertRecords(
  ...
  for (let i = 0; i < totalRecords; i += batchSize) {
    ...
    for (const record of batch) {
      const recordValues = [
        record.scats_site,
        record.interval_date,
        record.detector_number,
...
async function main() {
  ...
  let directoryPath: string = DEFAULT_DATA_DIR;
  let dryRun = false;
  ...
  if (filePath) {
    ...
    filesToProcess.push(...csvFiles.map((f) => path.join(directoryPath, f)));
  }

  console.log(`Found ${filesToProcess.length} CSV file(s) to process:\n`);
  filesToProcess.forEach((f) => console.log(`  - ${path.basename(f)}`));
  console.log();

  // Parse all CSV files
  let allRecords: TrafficRecord[] = [];
  ...
  try {
    ...
    // Insert records
    await insertRecords(pool, allRecords);
