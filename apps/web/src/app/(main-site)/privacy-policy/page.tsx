const page = () => {
  return (
    <div className="mx-auto mt-8 prose">
      ...
      <p>
        TaperAU is committed to providing quality services to you and this
      ...
      <p>
        This Personal Information is obtained in many ways including email
        newsletters and from third parties. We don’t guarantee website links or
      ...
      <p>
        TaperAU will not charge any fee for your access request, but may charge
