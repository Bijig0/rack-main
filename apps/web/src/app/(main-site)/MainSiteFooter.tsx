          ...
          <div className="block space-y-8 lg:grid lg:grid-cols-4 lg:space-y-0">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li>
                  <Link href={Urls.home} className="hover:underline">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href={Urls.blogs} className="hover:underline">
                    Blog
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <Link
                    href={Urls['data-deletion-instructions']}
                    className="hover:underline"
                  >
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <Link href={Urls.dashboard} className="hover:underline">
                    Dashboard
                  </Link>
                </li>
              </ul>
