...
export type BookingResponse = Awaited<
  ReturnType<
    typeof import('@calcom/features/bookings/lib/handleNewBooking').default
  >
>

export type InstantBookingResponse = Awaited<
  ReturnType<
    typeof import('@calcom/features/instant-meeting/handleInstantMeeting').default
  >
>
