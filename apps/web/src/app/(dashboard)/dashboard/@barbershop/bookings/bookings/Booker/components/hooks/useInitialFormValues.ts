...
} from '../../../lib/getBookingResponsesSchema'
import { BookerEvent } from '../../../types'
import { useBookerStore } from '../../store'

export type useInitialFormValuesReturnType = ReturnType<
  typeof useInitialFormValues
>
      ...
      if (!isRescheduling) {
        const defaults = {
          responses: {} as Partial<
            z.infer<ReturnType<typeof getBookingResponsesSchema>>
          >,
        }
