...
import { SeatsAvailabilityText } from '../../components/SeatsAvailabilityText'
import { useTimePreferences } from '../../lib'
import { BookerEvent } from '../../types'
import { fadeInUp } from '../config'
import { useBookerStore } from '../store'
import { FromToTime } from '../utils/dates'
import { useEmbedUiConfig, useIsEmbed } from './embed/embed-iframe'

// const WebTimezoneSelect = dynamic(
//   () =>
//     import('@calcom/ui/components/form/timezone-select/TimezoneSelect').then(
...
export const EventMeta = ({
  ...
  return (
    <div
      className={`${classNames?.eventMetaContainer || ''} relative z-10 p-6`}
