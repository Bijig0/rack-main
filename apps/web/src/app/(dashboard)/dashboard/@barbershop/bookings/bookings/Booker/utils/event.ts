...
import { useCompatSearchParams } from '../components/embed/useCompatSearchParams'
import { useSchedule } from '../schedules'
import { useBookerStore } from '../store'

export type useEventReturnType = ReturnType<typeof useEvent>
export type useScheduleForEventReturnType = ReturnType<
  typeof useScheduleForEvent
>
...
export const useEvent = () => {
  const [username, eventSlug] = useBookerStore(
