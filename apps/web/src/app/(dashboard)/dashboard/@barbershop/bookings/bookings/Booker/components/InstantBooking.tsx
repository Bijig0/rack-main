...
import { User, useLocale } from 'sanity'
    ...
    <div className=" bg-default border-subtle mx-2 block items-center gap-3 rounded-xl border p-[6px] text-sm shadow-sm delay-1000 sm:flex">
      <div className="flex items-center gap-3 ps-1">
        <div className="relative">
          <UserAvatarGroupWithOrg
            ...
            users={
              event.schedulingType !== SchedulingType.ROUND_ROBIN
                ? event.users
                : []
            }
          />
          <div className="absolute -bottom-0.5 -right-1 h-2 w-2 rounded-full border border-muted bg-green-500" />
        </div>
      ...
      <div className="mt-2 sm:mt-0">
        <Button
          ...
          size="sm"
          className="justify-center w-full rounded-lg sm:w-auto"
        >
          {t('connect_now')}
        </Button>
      </div>
