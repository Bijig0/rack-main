...
export const useOverlayCalendar = ({
  ...
  'connectedCalendars' | 'overlayBusyDates' | 'onToggleCalendar'
>) => {
  ...
  const [continueWithProvider, setContinueWithProvider] =
    useOverlayCalendarStore(
      (state) => [
        state.continueWithProviderModal,
        state.setContinueWithProviderModal,
      ],
      shallow,
    )
  const [calendarSettingsOverlay, setCalendarSettingsOverlay] =
    useOverlayCalendarStore(
      (state) => [
        state.calendarSettingsOverlayModal,
        state.setCalendarSettingsOverlayModal,
      ],
      shallow,
    )
  const setOverlayBusyDates = useOverlayCalendarStore(
    (state) => state.setOverlayBusyDates,
  )
  ...
  const handleToggleConnectedCalendar = (
