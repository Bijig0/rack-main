...
import { BookerLayouts } from '../Booker/types'
  ...
  return (
    <header
      className={classNames(
        `mb-3 flex w-full flex-row items-center font-medium dark:bg-muted dark:before:bg-muted`,
    ...
    >
      ...
      >
        ...
        >
          {nameOfDay('en', Number(date.format('d')), 'short')}
        </span>
        <span
          className={classNames(
